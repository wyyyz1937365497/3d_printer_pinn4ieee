% COLLECT_NAUTILUS_ALL - 收集Nautilus全部层数
%
% 处理Nautilus_Gears_Plate_PLA_3h36m.gcode的全部56层
%
...
output_dir = 'data_simulation_Nautilus_Gears_Plate_PLA_3h36m_sampled_56layers';
...
fprintf('预计需要2-5分钟，但会大幅加快后续仿真速度\n\n');
