"""
Train implicit state inference model (TCN)
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train implicit state inference model (TCN)')
    ...
    for epoch in range(args.epochs):
        ...
        if val_loss < best_val:
            best_val = val_loss
            ckpt_dir = Path('checkpoints/implicit_state_tcn')
